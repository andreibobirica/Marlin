...
#define TXT_MENU_HOME_MOVE                  "�ƶ�"
#define TXT_MENU_HOME_FILE                  "�ļ�"
#define TXT_MENU_HOME_EXTRUDE               "������"
#define TXT_MENU_HOME_PREHEAT               "Ԥ��"
#define TXT_MENU_HOME_RECOVERY              "�ϵ�����"
#define TXT_MENU_HOME_MORE                  "����"

//�ļ�ҳ��
#define TXT_MENU_FILE_SD_ERROR              "��SD����"
#define TXT_MENU_FILE_EMPTY                 "      ���ļ��У�"

//����ͷҳ��
#define TXT_MENU_EXTRUDE_MANUAL             "�ֶ�"
#define TXT_MENU_EXTRUDE_AUTOMATIC          "�Զ�"

#define TXT_MENU_LEVELING_UNLOCK            " ����X-Y"
//����ҳ��
#define TXT_MENU_HOME_MORE_LEVELING         "�ȴ���ƽ"
#define TXT_MENU_HOME_MORE_SETTINGS         "��������"
#define TXT_MENU_HOME_MORE_ABOUT            "����"
#define TXT_MENU_HOME_MORE_RETURN           " ����"
//���ڻ���ҳ��
#define TXT_MENU_ABOUT_MAX_SIZE_LABEL       "�����γߴ�(��x��x��):"
#define TXT_MENU_ABOUT_FW_VER_LABLE         "�̼��汾:"
//��������
#define TXT_MENU_SETTS_ACCL                 "���ٶ�(mm/s^2):"
#define TXT_MENU_SETTS_JERK_XY              "XY�ᶶ������(mm/s):"
#define TXT_MENU_SETTS_JERK_Z               "Z�ᶶ������(mm/s):"
#define TXT_MENU_SETTS_JERK_E               "E�ᶶ������(mm/s):"
#define TXT_MENU_SETTS_VMAX_X               "X������ٶ�(mm/s):"
#define TXT_MENU_SETTS_VMAX_Y               "Y������ٶ�(mm/s):"
#define TXT_MENU_SETTS_VMAX_Z               "Z������ٶ�(mm/s):"
#define TXT_MENU_SETTS_VMAX_E               "E������ٶ�(mm/s):"
#define TXT_MENU_SETTS_VMIN                 "��С�ٶ�(mm/s):"
#define TXT_MENU_SETTS_VTRAVEL              "��С�����ٶ�(mm/s):"
#define TXT_MENU_SETTS_AMAX_X               "X�������ٶ�(mm/s^2):"
#define TXT_MENU_SETTS_AMAX_Y               "Y�������ٶ�(mm/s^2):"
#define TXT_MENU_SETTS_AMAX_Z               "Z�������ٶ�(mm/s^2):"
#define TXT_MENU_SETTS_AMAX_E               "E�������ٶ�(mm/s^2):"
#define TXT_MENU_SETTS_ARETRACT             "�س���ٶ�(mm/s^2):"
//#define TXT_MENU_SETTS_ATRAVEL              "A-travel:"     
#define TXT_MENU_SETTS_STEP_X              "X��������/mm:"
#define TXT_MENU_SETTS_STEP_Y              "Y��������/mm:"
#define TXT_MENU_SETTS_STEP_Z              "Z��������/mm:"
#define TXT_MENU_SETTS_STEP_E              "E��������/mm:"
#define TXT_MENU_SETTS_CHECK_FILA          "���ϼ�⿪��:"
#define TXT_MENU_SETTS_LIST_ORDER          "��ӡ�ļ��б�˳��:"
#define TXT_MENU_SETTS_VALUE_ON            "��"   
#define TXT_MENU_SETTS_VALUE_OFF           "��"
#define TXT_MENU_SETTS_VALUE_FORWARD       "����"
#define TXT_MENU_SETTS_VALUE_INVERSE       "����"

//��ӡҳ��
#define TXT_MENU_PRINT_STATUS_HEATING       "������..."
#define TXT_MENU_PRINT_STATUS_PAUSING       "��ͣ��ӡ..."
#define TXT_MENU_PRINT_STATUS_RUNNING       "���ڴ�ӡ..."
#define TXT_MENU_PRINT_STATUS_RECOVERY      "�ϵ�������..."
#define TXT_MENU_PRINT_STATUS_FINISH        "��ӡ��ɣ�"
#define TXT_MENU_PRINT_STATUS_NO_FILAMENT   "�޺Ĳ�!"     
#define TXT_MENU_PRINT_CD_TIMER_NULL        "-- ʱ -- ��"
#define TXT_MENU_PRINT_CD_TIMER             "%d ʱ %d ��"
#define TXT_MENU_PRINT_TEMP_NULL            "B: --/--"

#define TXT_DIALOG_CAPTION_START             "��ʼ��ӡ"   
#define TXT_DIALOG_CAPTION_EXIT              "�˳�"
#define TXT_DIALOG_CAPTION_ABORT             "ֹͣ��ӡ"
#define TXT_DIALOG_CAPTION_ABORT_WAIT        "�ȴ�ֹͣ"
#define TXT_DIALOG_CAPTION_RECOVERY          "�ϵ�����"    
#define TXT_DIALOG_CAPTION_ERROR             "����"
#define TXT_DIALOG_CAPTION_RESTORE          "�ָ���������"
#define TXT_DIALOG_CAPTION_SAVE              "����"
#define TXT_DIALOG_CAPTION_NO_FIALMENT      "�޺Ĳ�" 
#define TXT_DIALOG_CAPTION_OPEN_FOLER       "���ļ���"

//��ĻУ׼
#define TXT_TFT_CONTROLLER_ID            "������ID:  %04X"
#define TXT_TFT_CONTROLLER               "������: %s"
#define TXT_TOUCH_CALIBRATION            "    ��ĻУ׼"
#define TXT_TOP_LEFT                     "���Ϸ�"
#define TXT_BOTTOM_LEFT                  "���·�"
#define TXT_TOP_RIGHT                    "���Ϸ�"
#define TXT_BOTTOM_RIGHT                 "���·�"
#define TXT_CALI_COMPLETED               "��ĻУ׼���"
#define TXT_X_CALIBRATION                "XУ׼ֵ:"
#define TXT_Y_CALIBRATION                "YУ׼ֵ:"
#define TXT_X_OFFSET              		 "Xƫ��ֵ:"
#define TXT_Y_OFFSET                     "Yƫ��ֵ:"
#define TXT_PROMPT_INFO1                 "��������������λ��"
#define TXT_PROMPT_INFO2                 "������ҳ�棡"
//��ӡ��ֹͣ
#define TXT_PRINTER_KILLED_INFO1        "   ��ӡ��ֹͣ����,"
#define TXT_PRINTER_KILLED_INFO2        "       ��������"
#define TXT_PRINTER_KILLED_INFO3        " "

#define TXT_PRINTER_TEMPERROR_INFO1      "�¶��쳣����"
#define TXT_PRINTER_TEMPERROR_INFO2      "��ӡ��."
#define TXT_PRINTER_TEMPERROR_INFO3      ""

//�Ի���
#define DIALOG_PROMPT_PRINT_START1		""//"Are you sure to start printing?"
#define DIALOG_PROMPT_PRINT_START2		"�Ƿ�ʼ��ӡ��"
#define DIALOG_PROMPT_PRINT_START3
#define DIALOG_PROMPT_PRINT_EXIT1 		""//"Job's done. Do you want to exit?"
#define DIALOG_PROMPT_PRINT_EXIT2		"��ӡ���,�Ƿ��˳���"
#define DIALOG_PROMPT_PRINT_EXIT3
#define DIALOG_PROMPT_PRINT_ABORT1 		"��ӡ��,�Ƿ������"//"Job's not done. Do you want to stop it?"
#define DIALOG_PROMPT_PRINT_ABORT2		"ӡ��"
#define DIALOG_PROMPT_PRINT_ABORT3
#define DIALOG_PROMPT_PRINT_RECOVERY1	""//"Are you sure to recovery printing?"
#define DIALOG_PROMPT_PRINT_RECOVERY2	"�Ƿ�ָ�������ӡ��"
#define DIALOG_PROMPT_PRINT_RECOVERY3	""
#define DIALOG_PROMPT_ERROR_READ1		"���ļ�ʧ�ܣ�"   //"Failed to read file, please try again."
#define DIALOG_PROMPT_ERROR_READ2		""
#define DIALOG_PROMPT_ERROR_READ3
#define DIALOG_PROMPT_SETTS_RESTORE1	""   //	"Are you sure to reset factory settings?"
#define DIALOG_PROMPT_SETTS_RESTORE2	"�Ƿ�ָ��������ã�"
#define DIALOG_PROMPT_SETTS_RESTORE3	""
#define DIALOG_PROMPT_SETTS_SAVE_OK1	""      //"Current settings has been saved."
#define DIALOG_PROMPT_SETTS_SAVE_OK2	"��ǰ�����ѱ���."
#define DIALOG_PROMPT_SETTS_SAVE_OK3
#define DIALOG_PROMPT_SETTS_SAVE1		""      //"Do you want to save current settings?"
#define DIALOG_PROMPT_SETTS_SAVE2		"�Ƿ񱣴浱ǰ���ã�"
#define DIALOG_PROMPT_SETTS_SAVE3		""
#define DIALOG_PROMPT_NO_FILAMENT1		"�Ƿ���?"      //"Do you want to change filament?"
#define DIALOG_PROMPT_NO_FILAMENT2		""
#define DIALOG_PROMPT_NO_FILAMENT3
#define DIALOG_ERROR_FILE_TYPE1	     	"���ļ�ʧ��.��֧"   //	"Failed to open file. Unsupported file type."
#define DIALOG_ERROR_FILE_TYPE2			"�ֵ��ļ�����."
#define DIALOG_ERROR_FILE_TYPE3
#define DIALOG_ERROR_TEMP_BED1	     	""     
#define DIALOG_ERROR_TEMP_BED2			"�ȴ��¶��쳣��"
#define DIALOG_ERROR_TEMP_BED3			""
#define DIALOG_ERROR_TEMP_HEAD1    	    "" 
#define DIALOG_ERROR_TEMP_HEAD2 		"����ͷ�¶��쳣��"
#define DIALOG_ERROR_TEMP_HEAD3			""
#define DIALOG_PROMPT_MAX_FOLDER1		""
#define DIALOG_PROMPT_MAX_FOLDER2		"��Ǹ,��֧�ֶ༶�ļ��У�"
#define DIALOG_PROMPT_MAX_FOLDER3
#define DIALOG_START_PRINT_NOFILA1      ""                 //No filament,please change filament and start printing
#define DIALOG_START_PRINT_NOFILA2		"�޺Ĳ�,�뻻�ϣ�"
#define DIALOG_START_PRINT_NOFILA3		//"start printing!"
